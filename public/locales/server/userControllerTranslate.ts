  ...
  en: {
    ...
    controllers: {
      ...
      changeEmailRequest: {
        ...
        confirmationEmailSent: 'Confirmation email sent to your current email address.',
        emailAlreadyExist: 'Email already exist in our system please try another email',
      },
      updateUserEmail: {
        requiredToken: 'Token must be required',
        message: 'Email has been successfully updated please verify your new email ',
    ...
    errors: {
      ...
      userAlreadyExist: 'User already exist in our system please try another email',
  ...
  uk: {
    model: {
      schema: {
        ...
        confirmPassword: {
          ...
          minlength: 'Підтвердження пароля має бути довжиною принаймні 10 символів',
    ...
    controllers: {
      ...
      changeEmailRequest: {
        ...
        invalidEmail: 'Недійсний формат електронної пошти для нової електронної пошти',
    ...
    errors: {
      ...
      userAlreadyExist: 'Користувач вже існує в нашій системі, спробуйте іншу електронну пошту',
      verificationCodeBlockedUntilMessage:
