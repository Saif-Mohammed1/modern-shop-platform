export const ProductTranslate = {
  en: {
    productActivityUpdatedSuccessfully: 'Product activity has been updated successfully',
  ...
  uk: {
    productActivityUpdatedSuccessfully: 'Активність продукту була успішно оновлена',
