  ...
  en: {
    functions: {
      ...
      createStripeProduct: {
        ...
        insufficientStock: (name: string) => `Insufficient stock for product ${name}`,
      },
      ...
      invoiceDetails: {
        ...
        footer: 'Thank you for choosing Website. For any inquiries, please contact us at',
      },
      handleStripeWebhook: {
    ...
    errors: {
      ...
      PartialReservation: (count: number) => `Partial reservation failed for ${count} products`,
  ...
  uk: {
    functions: {
      ...
      invoiceDetails: {
        ...
        footer: 'Дякуємо, що обрали Website. За всіма питаннями звертайтеся до нас за адресою',
      },
      handleStripeWebhook: {
    ...
    errors: {
      ...
      noUserFound: "Не знайдено жодного користувача, пов'язаного з цією адресою електронної пошти.",
