export const authControllerTranslate = {
  en: {
    functions: {
      ...
      isAuth: {
        ...
        noUserBelongingToken: 'The user belonging to this token no longer exists.',
      ...
      register: {
        ...
        passwordAndConfirmPasswordDontMatch: "password and confirmPassword don't match",
      },
      logIn: {
        invalidEmailOrPassword: 'Email or Password are incorrect',
        userNoLongerActive: 'This user is no longer active please contact support',
  ...
  uk: {
    functions: {
      modifyFinalResponse: {
        message: 'Користувач успішно створений. Перевірте свою електронну пошту для підтвердження.',
      },
      isAuth: {
        noExistingToken: 'Ви не увійшли в систему! Будь ласка, увійдіть, щоб отримати доступ.',
        noUserBelongingToken: 'Користувач, який належить до цього токену, більше не існує.',
        invalidSession: 'Ваша сесія недійсна.',
        recentlyChangedPassword: 'Користувач недавно змінив пароль! Будь ласка, увійдіть знову.',
      },
      restrictTo: {
      ...
      register: {
        ...
        passwordAndConfirmPasswordDontMatch: 'пароль і підтвердження пароля не збігаються',
      },
      logIn: {
    ...
    errors: {
      ...
      invalidOrExpiredVerificationCode: 'Недійсний або прострочений код верифікації.',
