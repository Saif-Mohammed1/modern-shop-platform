export const AuthTranslate = {
  en: {
    auth: {
      forgotPassword: {
        passwordResetLinkSent: 'Please check your email for password reset link',
      },
      ...
      confirmEmailChange: {
        emailChangeSuccess: 'Email change successful Please check your email for confirmation link',
      },
      verifyEmail: {
