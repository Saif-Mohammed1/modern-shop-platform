export const TwoFactorTranslate = {
  en: {
    ...
    success: {
      ...
      backupCodeRecovery: ' "Backup codes used ",',
    },
    error: {
  ...
  uk: {
    ...
    success: {
      ...
      backupCodeRecovery: "Резервний код використано",
    },
    error: {
      ...
      backupCodeAlreadyUsed: "Резерв ний код вже використано",
    },
    locked: (min: string) =>
      `Обліковий запис заблоковано. Спробуйте ще раз через ${min} хвилин`,
  },
} as const;
