export const shopPageTranslate = {
  en: {
    ...
    functions: {
      handleAddToCart: {
        outOfStock: 'This product is out of stock. Please check back later or contact support.',
  ...
  uk: {
    ...
    shopPage: {
      Metadata: {
        ...
        keywords: 'магазин, онлайн магазин, продукти, купити продукти, магазин онлайн',
      },
      content: {
