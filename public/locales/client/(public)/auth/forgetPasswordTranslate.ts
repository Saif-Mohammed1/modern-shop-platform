export const forgetPasswordTranslate = {
  en: {
    metadata: {
      ...
      description: 'Recover your password for My Awesome Shop and regain access to your account.',

      keywords: 'forgot password, recover password, reset password, My Awesome Shop',
    },
    functions: {
      handlePasswordReset: {
        hasToken: {
  ...
  uk: {
    metadata: {
      ...
      keywords: 'забули пароль, відновити пароль, скинути пароль, Мій крутий магазин',
    },
    functions: {
      handlePasswordReset: {
        hasToken: {
