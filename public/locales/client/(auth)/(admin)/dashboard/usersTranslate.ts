const addUsers = {
  ...
  uk: {
    metadata: {
      ...
      keywords: 'адміністратор, додати користувача, адміністратор додати користувача',
    },
...
const editUsers = {
  ...
  uk: {
    metadata: {
      ...
      keywords: 'адміністратор, редагувати користувача, адміністратор редагувати користувача',
    },
    title: 'Редагувати користувача',
