const GlobalSchemaError = {
  en: {
    review: {
      ...
      reviewText: {
        required: "ReviewText must be required",
        minlength: "ReviewText must be greater than 4",
        maxlength: "ReviewText must be less than 200",
      },
      createdAt: {
    ...
    product: {
      ...
      ratingsAverage: {
        min: "RatingsAverage must be greater than or equal to 1",
        max: "RatingsAverage must be less than or equal to 5",
      },
      ratingsQuantity: {
  ...
  uk: {
    ...
    product: {
      ...
      price: {
        required: "Ціна повинна бути обов'язковою",
        min: "Ціна повинна бути більшою за 0",
      },
      discount: {
        discountValidation: "Знижка повинна бути меншою за ціну",
      ...
      images: {
        required: "Зображення повинно бути обов'язковим",
      },
      link: {
        required: "Посилання повинно бути обов'язковим",
      },
      public_id: {
        required: "Публічний ідентифікатор повинен бути обов'язковим",
      },
      user: {
        required: "Користувач повинен бути обов'язковим",
      },
      ...
      ratingsAverage: {
        min: "Середній рейтинг повинен бути більшим за 1",
        max: "Середній рейтинг повинен бути меншим або рівним 5",
      },
      ratingsQuantity: {
