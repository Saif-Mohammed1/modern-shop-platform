...
export class WishlistRepository extends BaseRepository<IWishlist> {
  ...
  override async create(dto: Partial<IWishlist>, session?: ClientSession): Promise<IWishlist> {
  ...
  async deleteWishlist(
    ...
    const result = await this.model.deleteOne({productId, userId}, {session});
  ...
  async getUserWishlists(
    ...
    const queryBuilder = new QueryBuilder<IWishlist>(this.model, searchParams, queryConfig);
