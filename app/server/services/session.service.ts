...
export class SessionService {
  constructor(
    private readonly repository: SessionRepository = new SessionRepository(SessionModel),
  ...
  async revokeAllSessionsByAdmin(userId: string, session?: ClientSession): Promise<void> {
