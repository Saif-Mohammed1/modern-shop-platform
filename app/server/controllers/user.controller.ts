...
class UserController {
  ...
  async revokeAllUserSessions(req: NextRequest) {
    ...
    await this.userService.revokeAllSessionsByAdmin(req.id, device_info);
    return NextResponse.json(
  ...
  async forceRestPassword(req: NextRequest) {
    ...
    const device_info = await getDeviceFingerprint(req);
    await this.userService.forcePasswordResetByAdmin(req.id, device_info);
    return NextResponse.json(
  ...
  async lockUserAccount(req: NextRequest) {
    ...
    const device_info = await getDeviceFingerprint(req);
    await this.userService.lockUserAccountByAdmin(req.id, device_info);
    return NextResponse.json(
  ...
  async unlockUserAccount(req: NextRequest) {
    ...
    const device_info = await getDeviceFingerprint(req);
    await this.userService.unlockUserAccountByAdmin(req.id, device_info);
    return NextResponse.json(
